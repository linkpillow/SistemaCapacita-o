...
public class ServidorPublico {
    ...
    public String getEmail() {
        ...
        public double calcularSalarioHorasExtras(double ... horasTrabalhada){
            double salarioMensal = 0;
            for (double v : horasTrabalhada) {
                salarioMensal += v * valorHora;
            }
        ...
        public double calcularSalarioTotal (){
                return salario = this.salario + horasExtras;
        }
}
